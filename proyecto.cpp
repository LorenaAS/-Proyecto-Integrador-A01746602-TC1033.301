...
void empleado() {
  ...
  cout << "Ingrese su area: (Gerencia/Limpieza) "; cin >> areaUniforme;
  if (areaUniforme == "Gerencia") {
    colorUniforme = "Negro";
    salarioEmpleado = 10000;
  }
  else if (areaUniforme == "Limpieza") {
    colorUniforme = "Azul";
  ...
  Empleado empleado{nombreEmpleado, matriculaEmpleado, salarioEmpleado, uniforme};
  empleado.verNombreE();
